...
2. Check the wiki for Rule 3, Rule 6, and Rule 7 issues:
   ...
   - pages of type architecture/decision/integration/troubleshooting/lesson missing `confidence`, `verified_at`, or `verification_method`
