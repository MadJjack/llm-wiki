...
4. If it misses, use the Task Router's troubleshooting row, read related troubleshooting or lesson pages, and only then inspect source or other docs.
...
7. Never modify `wiki/raw/`. Use exact error strings where possible.
